...
if __name__ == "__main__":
    ...
    parser.add_argument("--results_dir", type=str, help="Path to test results",
        default="/Users/joel/Research/behaviour_mapping/blocal/results_area6_only.json")
        # default="/Users/joel/Research/behaviour_mapping/blocal/results_test.json")
    parser.add_argument("--test_dir", type=str, help="Path to test dataset",
        default="/Users/joel/Research/data/blocal_test_area6_only")
        # default="/Users/joel/Research/data/blocal_test_data")
    ...
    for dirname, dirmap in data_map.items():
        # Load the map and graph
        graph_path = os.path.join(args.test_dir, dirname, "behaviour_graph.json")
        ...
        for filename, file_results in dirmap.items():
            # if filename != 't9.h5':
            #     continue
            print(dirname, ": ", filename)
            traj_path = os.path.join(args.test_dir, dirname, filename)
            with h5py.File(traj_path, 'r') as f:
                visualise_file(
                    file_results, f, dirname, filename,
